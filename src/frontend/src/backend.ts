...
import type { AnalyticsEntry as _AnalyticsEntry, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAnalytics(arg0: string): Promise<Array<AnalyticsEntry>> {
        if (this.processError) {
            try {
    ...
    async getPublicProfile(arg0: string): Promise<UserProfile> {
        if (this.processError) {
            try {
    ...
    async logProfileView(arg0: string, arg1: Variant_desktop_mobile_unknown, arg2: string, arg3: Variant_qr_nfc_direct): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.logProfileView(arg0, to_candid_variant_n18(this._uploadFile, this._downloadFile, arg1), arg2, to_candid_variant_n19(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_AnalyticsEntry_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AnalyticsEntry): AnalyticsEntry {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        source: from_candid_variant_n13(_uploadFile, _downloadFile, value.source),
        timestamp: value.timestamp,
        deviceType: from_candid_variant_n14(_uploadFile, _downloadFile, value.deviceType)
    };
}
...
function from_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "qr" in value ? Variant_qr_nfc_direct.qr : "nfc" in value ? Variant_qr_nfc_direct.nfc : "direct" in value ? Variant_qr_nfc_direct.direct : value;
}
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "desktop" in value ? Variant_desktop_mobile_unknown.desktop : "mobile" in value ? Variant_desktop_mobile_unknown.mobile : "unknown" in value ? Variant_desktop_mobile_unknown.unknown : value;
}
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_AnalyticsEntry>): Array<AnalyticsEntry> {
    return value.map((x)=>from_candid_AnalyticsEntry_n11(_uploadFile, _downloadFile, x));
}
...
function to_candid_variant_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_desktop_mobile_unknown): {
    desktop: null;
} | {
    mobile: null;
} | {
    ...
    return value == Variant_desktop_mobile_unknown.desktop ? {
        desktop: null
    } : value == Variant_desktop_mobile_unknown.mobile ? {
        mobile: null
    } : value == Variant_desktop_mobile_unknown.unknown ? {
        unknown_: null
    } : value;
}
function to_candid_variant_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_qr_nfc_direct): {
    qr: null;
} | {
    nfc: null;
} | {
    ...
    return value == Variant_qr_nfc_direct.qr ? {
        qr: null
    } : value == Variant_qr_nfc_direct.nfc ? {
        nfc: null
    } : value == Variant_qr_nfc_direct.direct ? {
        direct: null
    } : value;
}
